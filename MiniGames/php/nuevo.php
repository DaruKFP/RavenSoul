...
echo"<form name='comentar1' id='comentar1' class='comentar1' method='POST' action='php/prueba.php'>";
    ...
    echo"<h3>Comenta</h3>";
    echo "<input type='text' id='comentar' required='Escibe algo' name='comentar' class='comentar' placeholder='Tema' cols='90' rows='5' style='font-size:12px;font-family:Comic Sans MS;color: #484c4c;'/>";
